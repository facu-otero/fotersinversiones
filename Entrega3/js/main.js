...
//acciones
const activoAppl = new activo("./photos/cards/appl.png","Apple", "APPL", 135, 40, "https://es.tradingview.com/chart/");
const activoMeli = new activo("./photos/cards/meli.jpg","Mercado Libre", "MELI", 1595, 20, "https://es.tradingview.com/chart/");
const activoTsla = new activo("./photos/cards/tsla.jpg","Tesla Corp.", "TSLA", 850, 35, "https://es.tradingview.com/chart/");
const activoDis = new activo("./photos/cards/dis.png","Walt Disney World Co.", "DIS", 170, 15, "https://es.tradingview.com/chart/");
const activoFb = new activo("./photos/cards/fb.jpg","Facebook", "FB", 350, "0.25", "https://es.tradingview.com/chart/");
//criptos
const activoBtc = new activo("./photos/cards/btc.jpg","Bitcoin", "BTCUSD", 32300, 25, "https://es.tradingview.com/chart/");
const activoLtc = new activo("./photos/cards/ltc.jpg","Litecoin", "LTCUSD", 165, 10, "https://es.tradingview.com/chart/");
const activoEth = new activo("./photos/cards/eth.jpg","Etherium", "ETHUSD", 2953, 15, "https://es.tradingview.com/chart/");
//dolar
const activoUsdD = new activo("./photos/cards/usd.jpg","Dolar Divisa", "USDD", 98, 10, "https://es.tradingview.com/chart/");
const activoUsdB = new activo("./photos/cards/usd.jpg","Dolar Billete", "USDB", 103, 10, "https://es.tradingview.com/chart/");
const activoUsdBlue = new activo("./photos/cards/usd.jpg","Dolar Blue", "USDBLUE", 158, 10, "https://es.tradingview.com/chart/");
// Creo los Array con los distintos grupos de activos

let cardAccionArray = [activoAppl, activoMeli, activoTsla, activoDis, activoFb]
let cardCriptoArray = [activoBtc, activoLtc, activoEth]
let cardDivisaArray = [activoUsdD, activoUsdB, activoUsdBlue]
